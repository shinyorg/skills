...
**NuGet**: `Shiny.Blazor.Controls` (+ `Shiny.Blazor.Controls.Markdown`, `Shiny.Blazor.Controls.MermaidDiagrams`, `Shiny.Blazor.Controls.Barcodes`; the Blazor docking host is in the main package, not an add-on)
