...
| **`Shiny.Blazor.Controls.Docking`** (`Shiny.Blazor.Controls.Docking` namespace) | Blazor apps. WASM-supported in v1; Blazor Server / `BlazorWebView` will be supported as the contracts stabilize |
